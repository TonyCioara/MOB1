...
class Truck: Vehicles {
    ...
    var wheelNumber = 6
    var doorNumber = 2
    var modelProperties = "Can carry heavy weights"
}

class Motocycle: Vehicles {
    var maxSpeed = 180
    var wheelNumber = 2
    var doorNumber = 0
    var modelProperties = "Can move through traffic"
}
...
class Bus: Vehicles {
    ...
    var wheelNumber = 8
    var doorNumber = 4
    var modelProperties = "Can carry large groups of people"
}

let truck = Truck()
let motocycle = Motocycle()
let bus = Bus()
