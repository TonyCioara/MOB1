...
func doesApply(a: Int, b: Int, someFunc: (Int, Int) -> Bool) -> Bool {
    return someFunc(a, b)
}
...
doesApply(a: 47695, b: 344832, someFunc: areBothDivisibleByThree)
...
doesApply(a: 33, b: 123) { (a: Int, b: Int) -> Bool in
    if sumOfDigits(a: a) == sumOfDigits(a: b) {
        return true
    } else {
        return false
    }
...
func manipulateString(a: String, b: String, someFunc: (String, String) -> String?) -> String? {
    return someFunc(a, b)
}
func concatenateSmallStrings(a: String, b: String) -> String? {
    if a.count <= 5 && a.count <= 5 {
        return a + b
    } else {
        return nil
    }
...
manipulateString(a: "abc", b: "def", someFunc: concatenateSmallStrings)
